...
public class ArticleBean implements Serializable {
	...
	public String delete() {
		...
		try {
			...
			Section section = deletableEntity.getSection();
			section.getArticles().remove(deletableEntity);
			deletableEntity.setSection(null);
			this.entityManager.merge(section);
	...
	public Converter getConverter() {
		...
		return new Converter() {
			...
			public String getAsString(FacesContext context,
				...
				return String.valueOf(((Article) value).getIdArticle());
			}
		};
	}
